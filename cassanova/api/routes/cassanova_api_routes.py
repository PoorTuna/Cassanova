...
@cassanova_api_router.get("/cluster/{cluster_name}/keyspaces")
...
@cassanova_api_router.get("/cluster/{cluster_name}/keyspace/{keyspace_name}")
...
@cassanova_api_router.get("/cluster/{cluster_name}/keyspace/{keyspace_name}/tables")
...
@cassanova_api_router.get("/cluster/{cluster_name}/keyspace/{keyspace_name}/table/{table_name}")
